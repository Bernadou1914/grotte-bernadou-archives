    ...
    <div className="min-h-screen bg-[#FBF9F5] p-4 md:p-8">
      <div className="max-w-2xl mx-auto space-y-6">
        <div className="flex items-center gap-4">
          <Link href="/" className="p-2 hover:bg-black/5 rounded-lg transition-colors text-xl font-bold">
            ←
          </Link>
        ...
        <form onSubmit={(e) => e.preventDefault()} className="bg-white p-6 rounded-xl border border-black/10 space-y-4 shadow-sm">
          ...
          <button type="submit" className="w-full bg-[#8C4327] hover:bg-[#72351E] text-white py-3 rounded-lg font-medium transition-colors">
